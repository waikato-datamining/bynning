...
class Rational(RationalABC):
    ...
    def __ceil__(self):
        raise NotImplementedError(Rational.__ceil__.__qualname__)
    ...
    def __neg__(self):
        raise NotImplementedError(Rational.__neg__.__qualname__)

    def __pos__(self):
        raise NotImplementedError(Rational.__pos__.__qualname__)

    def __mul__(self, other):
        raise NotImplementedError(Rational.__mul__.__qualname__)

    def __rmul__(self, other):
        raise NotImplementedError(Rational.__rmul__.__qualname__)
